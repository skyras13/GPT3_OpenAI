...
const Possibility = () => (
  <div className="skyras13software__possibility section__padding" id="possibility">
    <div className="skyras13software__possibility-image">
      <img src={possibilityImage} alt="possibility" />
    </div>
    <div className="skyras13software__possibility-content">
